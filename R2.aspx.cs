...
namespace Rent_A_Car
{
    public partial class R2 : System.Web.UI.Page
    {
        ...
        public void Dataretrieve()
        {
            ...
            SqlCommand sqlcom1 = new SqlCommand("Rent_A_Car_SP_Report_ServiceBills", MyConnection.MyDbCon());
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string TID = gr.Cells[1].Text;
            Response.Redirect("Bill3Service.aspx?val=" + TID);
        }
    }
}